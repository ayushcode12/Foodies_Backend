...
import com.aj.foodiesapi.Entity.OrderEntity;
import com.aj.foodiesapi.Repository.CartRepository;
import com.aj.foodiesapi.Repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService{
    ...
    public void verifyPayment(Map<String, String> paymentData, String status) {
        String raxorpayOrderId = paymentData.get("razorpay_order_id");
        OrderEntity existingOrder = orderRepository.findByRazorpayOrderId(raxorpayOrderId)
